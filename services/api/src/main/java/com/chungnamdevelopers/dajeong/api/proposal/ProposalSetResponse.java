...
public record ProposalSetResponse(
        ...
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED) int eligibleMemberCount,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED) int participantCount,
        @Schema(nullable = true) UUID myVoteProposalId,
        @Schema(nullable = true) String shortageReason,
        @Schema(nullable = true) String failureCode,
        @Schema(nullable = true) Instant votingOpenedAt,
        @Schema(nullable = true) Instant votingDeadlineAt,
        @Schema(nullable = true) UUID winnerProposalId,
        @Schema(nullable = true) UUID appliedItineraryVersionId,
        @Schema(nullable = true) VoteClosingReason closingReason,
        @Schema(nullable = true) Instant closedAt,
        @Schema(nullable = true) Instant appliedAt,
